# preguntas-entrevista-react (midudev/preguntas-entrevista-react)

## 프로젝트 개요
세계적인 빅테크 기업들의 프론트엔드 실무 기술 면접에서 단골로 출제되는 핵심 질문과 모범 답변을 총정리한 "프론트엔드 면접 족보 바이블"
단순 암기용 문답을 넘어 실무에서 마주치는 까다로운 문제들의 원리와 해결 노하우를 명쾌하게 해설
이직을 준비하는 경력 개발자부터 첫 취업을 앞둔 신입 지원자까지 면접관의 의도를 꿰뚫고 합격률을 높여주는 필수 교재
